...
//        System.out.println(records);
    ...
    public static void createCSV(){
        try {
            File file = new File("Users/ajay/Desktop/Banking_Final_Project/src/input.csv");
    ...
    public static List<List<String>> readCSV(){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("Users/ajay/Desktop/Banking_Final_Project/src/input.csv"))) {
